...
public class LeftRight3DDrawerLayout extends LeftRightDrawerLayout {

    public LeftRight3DDrawerLayout(Context context) {
        super(context);
    }


    public LeftRight3DDrawerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LeftRight3DDrawerLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    @Override
    void updateSlideOffset(CardView child, LeftRightDrawerLayout.Setting setting, float width, float slideOffset, boolean isLeftDrawer) {
    ...
    @Override
    LeftRightDrawerLayout.Setting createSetting() {
        return new Setting();
    }
    ...
    class Setting extends LeftRightDrawerLayout.Setting {
        float degree;
    }
}
