...
public class LeftRightDrawerLayout extends DrawerLayout {
    ...
    public LeftRightDrawerLayout(Context context) {
        super(context);
        init(context, null, 0);
    ...
    public LeftRightDrawerLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        addDrawerListener(new DrawerListener() {
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
                LeftRightDrawerLayout.this.drawerView = drawerView;
